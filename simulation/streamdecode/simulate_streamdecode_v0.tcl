...
add_force {/streamdecode/newblockin} -radix bin {1 0ns} {0 50ns}

add_force {/streamdecode/reset} -radix bin {1 0ns} {0 10ns}

add_force {/streamdecode/blockin} -radix bin {1101010011101010000100001011110111100101101111101100110010011010 0ns} {0101010001110110101000010000110100111100110100011000100111010101 10ns} {0110010010100101111110100011101000001111111111111110011010101010 20ns} {0101011111101011000100001101111111110011101111111100001011011100 30ns}
